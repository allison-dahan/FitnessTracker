...
public class MockWorkoutRepository : IWorkoutRepository
{
    ...
    public MockWorkoutRepository()
    {
        ...
        // Add the WorkoutExercise to the Workout's collection
        var workoutExercise = new WorkoutExercise  // Pass the workout to the constructor
        {
            Workout = workout,
            ExerciseId = 1,
        ...
        workout.WorkoutExercises = new List<WorkoutExercise> { workoutExercise };

        // Add the workout to the list
        _workouts = new List<Workout> { workout };
    }
